...
All tests must pass before any change is considered complete. There are currently 611 tests across 6 test files.
...
- `docs/PLAN.md` — Milestone roadmap with status (Milestones 1-25 done)
