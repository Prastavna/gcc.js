...
All tests must pass before any change is considered complete. There are currently 625 tests across 6 test files.
...
- `docs/PLAN.md` — Milestone roadmap with status (Milestones 1-26 done)
